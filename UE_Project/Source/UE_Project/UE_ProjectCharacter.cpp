...
{
	// If UE_Project is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in UE_Project.Build.cs is not automatically propagated
